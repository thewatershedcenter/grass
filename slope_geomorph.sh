...
while getopts ":h" option; do
   case $option in
      h) # display Help
        ...
        echo "      FLT  - Flatness threshold for geomorphons algorithm"
        echo "      SZ   - Neighborhood size for the summation"
